...
import { FileText, AlertCircle, ArrowLeft, Phone, Heart, Shield } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="bg-accent/20 border-accent">
          ...
          <CardContent className="space-y-2">
            ...
            <Button variant="ghost" className="w-full justify-start" onClick={() => navigate('/carer/pseudonym-policy')}>
