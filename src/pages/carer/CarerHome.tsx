      ...
      <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
        ...
        {isLoading ? (
          <div className="space-y-4">
            ...
            {latestInsight && <Card className={`p-4 sm:p-6 bg-gradient-to-br border border-border/30 ${getMoodColor(latestInsight.mood_score)}`}>
                <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 space-y-3 w-full">
                    ...
                    <p className="text-sm font-semibold text-primary">{childNickname}'s recent journal entry</p>
            ...
            {/* Quick Actions */}
            <div className="grid gap-3">
              <Button variant="outline" className="justify-start h-auto py-4 border-accent/50 hover:bg-accent/10 relative bg-background/80 backdrop-blur-sm" onClick={() => navigate('/carer/safeguarding')}>
